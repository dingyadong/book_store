						...
						<div class="am-tabs" id="doc-my-tabs">
							...
							<div class="am-tabs-bd">
								<div class="am-tab-panel am-active">
										<form action="/shixunexample/helpRegister" method="post">
					<div class="user-email">
										<label for="email"><i class="am-icon-smile-o"></i></label>
										<input type="text"  name = "username" id="username" placeholder="用户昵称">
                 </div>							
							   <div class="user-email">
										<label for="email"><i class="am-icon-user"></i></label>
										<input type="text" name = "logname" id="logname" placeholder="请输入账号">
                 </div>										
                 <div class="user-pass">
								    ...
								    <input type="password"  name = "password" id="password" placeholder="设置密码">
										...
										<font color="red">${register.backNews}</font>
