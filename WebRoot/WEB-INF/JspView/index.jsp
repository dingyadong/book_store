...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<div class="am-container header">
				<ul class="message-l">
					<div class="topMessage">
						<div class="menu-hd">
							...
							<a href="login.jsp" target="_top" class="h">欢迎光临，<c:out value="${user.name}" default="你还没有登录"></c:out></a>
				...
				<ul class="message-r">
					...
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a  href="/shixunexample/listOrderItem" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h"></strong></a></div>
					</div>
						<div class="topMessage mini-cart">
					...
					<div class="topMessage favorite">
						<div class="menu-hd"><a href="FavoritesListServlet" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a></div>
				</ul>
				</div>
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="ProductIntroductionServlet?id=28"><img src="images/ad1.jpg" /></a></li>
								<li class="banner2"><a href="ProductIntroductionServlet?id=45"><img src="images/ad2.jpg" /></a></li>
								<li class="banner3"><a href="ProductIntroductionServlet?id=69"><img src="images/ad3.jpg" /></a></li>
								<li class="banner4"><a href="ProductIntroductionServlet?id=1"><img src="images/ad4.jpg" /></a></li>
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								...
								<em>
									...
									<c:out value="${user.name}" default="你还没有登录"></c:out>
									</span>
							...
							<span class="s-name"> 
										<a class="" href="LoginOutServlet">退出</a>
									</span>
					...
					<div class="am-g am-g-fixed recommendation">
						...
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="ProductIntroductionServlet?id=69"><img src="images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<a href="ProductIntroductionServlet?id=45"><img src="images/tj1.png "></img></a>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<a href="ProductIntroductionServlet?id=38"><img src="images/tj2.png "></img></a>
							</div>
						</div>
		...
		<c:forEach  var="x" begin="0" end="13" step="1" varStatus="status">

				<div id="f${(status.current)%10+1}">
							<!--甜点-->
							...
							<div class="am-g am-g-fixed floodFour">
								<div class="am-u-sm-5 am-u-md-4 text-one list ">
									<div class="word">
										<a class="outer" href="#"><span class="inner"><b class="text">历史</b></span></a>
										<a class="outer" href="#"><span class="inner"><b class="text">哲学</b></span></a>
										<a class="outer" href="#"><span class="inner"><b class="text">绘画</b></span></a>	
										<a class="outer" href="#"><span class="inner"><b class="text">通话</b></span></a>
										<a class="outer" href="#"><span class="inner"><b class="text">小说</b></span></a>
										<a class="outer" href="#"><span class="inner"><b class="text">地理</b></span></a>									
									</div>
									<a href="ProductIntroductionServlet?id=1">
										<div class="outer-con ">
											<div class="title ">
											开抢啦！
											</div>
		 ...
		                             			<c:forEach items="${books}" var="book"  begin="${x*6}" end="${x*6+5}" step="1" varStatus="status1">
		 							<c:if test="${status1.index%6==0}"><div class="am-u-sm-7 am-u-md-4 text-two sug"></c:if>
									<c:if test="${status1.index%6==1}"><div class="am-u-sm-7 am-u-md-4 text-two"></c:if>	
									<c:if test="${status1.index%6==2}"><div class="am-u-sm-3 am-u-md-2 text-three big"></c:if>	
									<c:if test="${status1.index%6==3}"><div class="am-u-sm-3 am-u-md-2 text-three sug"></c:if>	
									<c:if test="${status1.index%6==4}"><div class="am-u-sm-3 am-u-md-2 text-three"></c:if>	
									<c:if test="${status1.index%6==5}"><div class="am-u-sm-3 am-u-md-2 text-three last big"></c:if>
									<div class="outer-con ">
											<div class="title ">
											...
											<a href="addOrderItem?pid=${book.id}&num=1"><i class="am-icon-shopping-basket am-icon-md  seprate"></i></a>
										</div>
						<a href="ProductIntroductionServlet?id=<c:out value="${book.id}"/>"><img style="width: auto;height: auto; min-width: 50%;min-height: 30%;max-width: 75%;max-height: 75%;" src="image/<c:out value="${book.img}"/>" /></a>
		...
		<div class=tip>
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								...
								<ul class="user_info ">
									<li>用户名:<c:out value="${user.name}" default="你还没有登录"></c:out></li>
									<li>级&nbsp;别:普通会员</li>
								</ul>
							</div>
					...
					<a href="/shixunexample/listOrderItem">
					...
					<div class="quick_toggle ">
						<li class="qtitem ">
							<a href="http://wpa.qq.com/msgrd?v=3&uin=947431253&site=qq&menu=yes "><span class="kfzx "></span></a>
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="images/weixin_code_145.jpg " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
